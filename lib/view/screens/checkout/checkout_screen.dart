      ...
      body: _isLoggedIn ? GetBuilder<RestaurantController>(builder: (restController) {
        ...
        return GetBuilder<CouponController>(builder: (couponController) {
          return GetBuilder<OrderController>(builder: (orderController) {
            ...
            double _subTotal = _price + _addOns;
            double _orderAmount = (_price - _discount) + _addOns - _couponDiscount;
            ...
            if(restController.restaurant != null) {
              ...
              || (Get.find<SplashController>().configModel.freeDeliveryOver != null
                      && _orderAmount >= Get.find<SplashController>().configModel.freeDeliveryOver)) {
                _deliveryCharge = 0;
              }
            }
                    ...
                    child: Center(child: SizedBox(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        restController.restaurant.scheduleOrder ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          SizedBox(
                            height: 50,
                            child: orderController.timeSlots != null ? orderController.timeSlots.length > 0 ? ListView.builder(
                              scrollDirection: Axis.horizontal,
                              shrinkWrap: true,
                              physics: BouncingScrollPhysics(),
                              ...
                              itemBuilder: (context, index) {
                                return SlotWidget(
                                  title: (index == 0 && orderController.selectedDateSlot == 0) ? 'now'.tr
                        ...
                        SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                        couponController.discount > 0 ? Column(children: [
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  child: !orderController.isLoading ? CustomButton(buttonText: 'confirm_order'.tr, onPressed: () {
                    ...
                    if(_orderAmount < restController.restaurant.minimumOrder) {
                      ...
                      orderController.placeOrder(PlaceOrderBody(
                        ...
                        couponCode: Get.find<CouponController>().discount > 0 ? Get.find<CouponController>().coupon.code : null,
