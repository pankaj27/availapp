    ...
    return Scaffold(
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        ...
        if(orderController.orderDetails != null) {
          ...
          _taxPercent = _order.restaurant.tax;
          for(OrderDetailsModel orderDetails in orderController.orderDetails) {
            ...
            double _disc = orderDetails.foodDetails.restaurantDiscount > 0 ? orderDetails.foodDetails.restaurantDiscount : orderDetails.foodDetails.discount;
            String _discType = orderDetails.foodDetails.restaurantDiscount > 0 ? 'percent' : orderDetails.foodDetails.discountType;
            _discount = _discount + (PriceConverter.calculation(orderDetails.price, _disc, _discType, orderDetails.quantity));
          }
          if(_order.restaurant != null && _order.restaurant.discount != null) {
            if(_order.restaurant.discount.maxDiscount != 0 && _order.restaurant.discount.maxDiscount < _discount) {
              _discount = _order.restaurant.discount.maxDiscount;
            }
            if(_order.restaurant.discount.minPurchase != 0 && _order.restaurant.discount.minPurchase > _itemsPrice) {
              _discount = 0;
            }
          }
        }
        double _subTotal = _itemsPrice + _addOns;
        double _orderAmount = (_itemsPrice - _discount) + _addOns - _couponDiscount;
          ...
          Expanded(child: Scrollbar(child: SingleChildScrollView(
            ...
            child: Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                Text(
                  DateConverter.isoStringToLocalDateOnly(_order.createdAt),
                  style: robotoRegular,
                ),
              ]),
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Text(
                    _order.orderStatus == 'delivered' ? '${'delivered_at'.tr} ${DateConverter.isoStringToLocalDateOnly(_order.updatedAt)}'
