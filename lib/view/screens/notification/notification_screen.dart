          ...
          child: Scrollbar(child: SingleChildScrollView(
            ...
            child: Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                DateTime _originalDateTime = DateConverter.isoStringToLocalDate(notificationController.notificationList[index].createdAt);
                ...
                return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  _addTitle ? Padding(
                    ...
                    child: Text(DateConverter.isoStringToLocalDateOnly(notificationController.notificationList[index].createdAt)),
                  ) : SizedBox(),
