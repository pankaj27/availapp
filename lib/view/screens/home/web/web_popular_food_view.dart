    ...
    return Column(
      ...
      children: [
        ...
        productController.popularProductList != null ? GridView.builder(
          ...
          itemCount: productController.popularProductList.length > 7 ? 8 : productController.popularProductList.length,
            ...
            if(index == 7) {
              return InkWell(
                ...
                child: Container(
                  ...
                  child: Text(
                    '+${productController.popularProductList.length-7}\n${'more'.tr}', textAlign: TextAlign.center,
        ...
        ) : WebPopularFoodShimmer(productController: productController),
      ],
    );
  }
}
...
class WebPopularFoodShimmer extends StatelessWidget {
  final ProductController productController;
  WebPopularFoodShimmer({@required this.productController});
